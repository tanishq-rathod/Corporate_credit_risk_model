...
| File | Description |
|------|-------------|
| fig1_distributions.png | Point estimate vs full Monte Carlo distribution, all firms |
| fig2_histograms.png | Per-firm score distributions with VaR thresholds |
| fig3_validation.png | Point estimate vs VaR ranking against ratings (0.32 vs 0.74) |
| fig4_metric_failure.png | Debt-to-equity failure vs debt-to-assets fix |
| fig5_merton.png | Merton distance-to-default vs agency rating |
